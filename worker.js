      ...
      if (
        ...
        */
        ...
        if (text.startsWith("/start")) {
          ...
          /*
            Открываем Mini App.
            URL берём из переменной WEBAPP_URL.
          */
      ...
      if (
        ...
        if (
          ...
          return json({
            ok: false,
            error:
              "Этот кейс нельзя открыть за Coins"
          }, headers, 400);
        }
      ...
      if (
        ...
        if (!referrer) {
          return json({
            ok: false,
            error:
              "Пригласивший пользователь не найден"
          }, headers, 404);
        }
